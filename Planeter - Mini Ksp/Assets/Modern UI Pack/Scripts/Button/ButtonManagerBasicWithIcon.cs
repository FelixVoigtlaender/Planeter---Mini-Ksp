...
{
    public class ButtonManagerBasicWithIcon : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        // Content
        ...
        void Update()
        {
            if (useRipple == true && Input.GetMouseButtonDown(0) && isPointerOn == true)
