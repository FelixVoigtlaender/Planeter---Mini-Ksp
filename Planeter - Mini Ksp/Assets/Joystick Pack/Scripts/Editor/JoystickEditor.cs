...
public class JoystickEditor : Editor
{
    ...
    private SerializedProperty snapBack;
    ...
    protected virtual void OnEnable()
    {
        ...
        snapBack = serializedObject.FindProperty("snapBack");
    ...
    protected virtual void DrawValues()
    {
        ...
        EditorGUILayout.PropertyField(snapBack, new GUIContent("Snap Back", "Snap the cursor back to the initial position"));
        EditorGUILayout.PropertyField(normalize, new GUIContent("Normalize", "Normalizes the Input to always have the max magnitude"));
    }
